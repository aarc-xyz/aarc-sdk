...
import { TransferTokenDetails, MigrationResponse, TokenData, TransactionsResponse } from '../src/utils/AarcTypes';
...
jest.mock('../src/helpers/GelatoHelper', () => ({
    ...
    getGelatoTransactionStatus: jest.fn().mockImplementation(async () => '0x127hy123'),
}));
